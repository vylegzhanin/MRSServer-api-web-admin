...
public class StatusAPIsApi {
    ...
    private com.squareup.okhttp.Call statusCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public InlineResponse2006 status() throws ApiException {
        ApiResponse<InlineResponse2006> resp = statusWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2006> statusWithHttpInfo() throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call statusAsync(final ApiCallback<InlineResponse2006> callback) throws ApiException {
