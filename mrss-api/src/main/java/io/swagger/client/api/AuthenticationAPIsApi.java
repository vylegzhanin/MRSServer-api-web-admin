...
public class AuthenticationAPIsApi {
     ...
     */
    public InlineResponse200 login(LoginRequest loginRequest) throws ApiException {
        ApiResponse<InlineResponse200> resp = loginWithHttpInfo(loginRequest);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> loginWithHttpInfo(LoginRequest loginRequest) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call loginAsync(LoginRequest loginRequest, final ApiCallback<InlineResponse200> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call renewTokenCall(RenewTokenRequest renewTokenRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = renewTokenRequest;
        
        // create path and map variables
        String localVarPath = "/login/refreshToken".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse200 renewToken(RenewTokenRequest renewTokenRequest) throws ApiException {
        ApiResponse<InlineResponse200> resp = renewTokenWithHttpInfo(renewTokenRequest);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> renewTokenWithHttpInfo(RenewTokenRequest renewTokenRequest) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call renewTokenAsync(RenewTokenRequest renewTokenRequest, final ApiCallback<InlineResponse200> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call revokeRefreshTokenCall(String refreshToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse200 revokeRefreshToken(String refreshToken) throws ApiException {
        ApiResponse<InlineResponse200> resp = revokeRefreshTokenWithHttpInfo(refreshToken);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> revokeRefreshTokenWithHttpInfo(String refreshToken) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call revokeRefreshTokenAsync(String refreshToken, final ApiCallback<InlineResponse200> callback) throws ApiException {
